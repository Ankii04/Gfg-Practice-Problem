<h2><a href="https://www.geeksforgeeks.org/problems/merge-two-strings2736/1">Merge two strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><p rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><span style="font-size:18px" rtrvr-ls="5~hs,6~hs,8~hs,9~hs">Given two&nbsp;strings <strong>S1</strong> and <strong>S2</strong> as input, the task is to merge them alternatively i.e. the first character of S1&nbsp;then the first character of S2 and so on till the strings end.</span><br>
<span style="font-size:18px" rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><strong>NOTE:</strong>&nbsp;Add the whole string if other string is empty.</span></p>

<p rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><span style="font-size:18px"><strong>Example 1:</strong></span></p>

<pre rtrvr-ls="49~hs"><span style="font-size:18px"><strong>Input:</strong>
S1 = "Hello" S2 = "Bye"
