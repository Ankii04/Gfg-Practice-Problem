<h2><a href="https://www.geeksforgeeks.org/problems/min-number-of-flips3210/1">Min Number of Flips</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><p rtrvr-ls="5~hs,6~hs,8~hs,9~hs,49~hs"><span style="font-size: 18px;" rtrvr-ls="5~hs,6~hs,8~hs,9~hs">Given a binary string <strong rtrvr-ls="5~hs,6~hs,8~hs,9~hs">s </strong>of length n. We need to make this string a sequence of alternate characters by flipping some of the bits, our goal is to minimize the number of bits to be flipped.</span></p>
<p rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><span style="font-size: 18px;"><strong>Examples:</strong></span></p>
<pre rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><span style="font-size: 18px;"><strong>Input: </strong>s = "001"
<strong>Output: </strong>1
<strong>Explanation:</strong> We can flip the 0th bit to 1 to have "101".
</span></pre>
<pre rtrvr-ls="5~hs,6~hs,8~hs,9~hs"><span style="font-size: 18px;"><strong>Input: </strong>s = "0001010111" 
